...
export default function Header() {
    window.addEventListener("scroll",()=>{
        if(  window.scrollY > 50){
            ...
            $("header").addClass("translateheader");
        }
        else if(  window.scrollY < 50){
            $("header").removeClass("header2")
            $("header").removeClass("translateheader");
        }
    })
    useEffect(()=>{
        ...
        <div className='header-container'>
            <div className='nav-navbar'>
                ...
                <div className='navbar-logo'>
                    <a className="brand" href="#">
                        <div className='svg-Bosta-Logo'>
                            <svg width="1em" height="1em" viewBox="0 0 111 34" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                ...
                <div className='collapsed-links'>
                    {/*left-collapsed-links*/}
                    <div className='left-collapsed-links'>
                        <ul className="navbar-list">
                            <li className="">
                                <span className="drop-link" id="">
                                    <span>Products</span>
                                ...
                                <div className="drop-menu">
                                    <span className="list-item">Solution</span>
                                    <span className="list-item">Dashboard</span>
                                    <span className="list-item">Mobile App</span>
                                </div>
                            </li>
                            <li className="">
                                <span className="drop-link">
                                    <span>Integration</span>
                                    <div className='toggle'>
                                        <i className="fa-solid fa-chevron-down"></i>
                                    </div>
                                </span>
                                <div className="drop-menu" aria-labelledby="navbarDropdown">
                                    <span className="list-item">Shopfiy</span>
                                    <span className="list-item">WooCommerce</span>
                                    <span className="list-item">Custom APIs</span>
                                </div>
                            </li>
                            <li className="">
                                <span className="drop-link">
                                ...
                                <div className="drop-menu" aria-labelledby="navbarDropdown">
                                    <span className="list-item">Businesses</span>
                                    <span className="list-item">SMEs</span>
                                </div>
                            </li>
                            <li className="">
                                <span className="drop-link underlinelink">Pricing</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className='right-collapsed-links'>
                        <ul className="navbar-list">
                            <li className="tracking-shipment">
                                ...
                                <div className="drop-menu">
                                    <div className="padd">
                                        <div className='trackshipment-box'>
                                            <h5>Track Your Shipment</h5>
                                            <span className='input-field'>
                                                <span className='search-icon'><i className="fa-solid fa-magnifying-glass"></i></span>
                                                <input className='form-control' placeholder='Tracking No.'/>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li className="">
                                <span className="underlinelink">Sign In</span>
                            </li>
                            <li className="signupbtn">
                                <span className="underlinelink">Sign Up</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className='centeral-links'>
                    ...
                    <ul className='navbar-list'>
                        <li className="">
                            <span className="drop-link">العربية</span>
                        </li>
                    </ul>
                    <div className='btns'>
